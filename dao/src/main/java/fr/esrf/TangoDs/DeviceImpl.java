...
public abstract class DeviceImpl extends Device_2POA implements TangoConst {
     ...
     * state and status
     *
     * @param cl     Reference to the device class object
     * @param d_name The device name
     * @param de     The device description field
     * @param st     The device creation state
     * @param sta    The device creation status
     * @throws DevFailed Re-throw of the exception thrown during the creation of
     ...
     * @throws DevFailed Re-throw of the exception thrown by the command_handler
     *                   method. Click <a
     *                   href="../../tango_basic/idl_html/Tango.html#DevFailed"
     *                   >here</a> to read <b>DevFailed</b> exception specification
     */
     ...
     * client
     *
     * @param n The number of actions description which must be returned to
     ...
     * the device
     * @throws DevFailed If it is not possible to read the device black box. Click
     *                   <a
     ...
     *
     * @param command The specified command name.
     * @return The device command list. One DevCmdInfo is initialised for each
     * device command
     */
    // ===========================================================================
     ...
     * @throws DevFailed Thrown if the command does not exist. Click <a
     *                   href="../../tango_basic/idl_html/Tango.html#DevFailed"
     *                   >here</a> to read <b>DevFailed</b> exception specification
     */
     ...
     * @throws DevFailed Thrown if one of the attribute does not exist. Click <a
     *                   href
     ...
     *
     * @param new_conf The attribute(s) new configuration list. There is one
     ...
     * initialised for each wanted attribute
     * @throws DevFailed Thrown if one of the attribute does not exist or if a
     ...
     *
     * @param names  The attribute name list
     * @param source could be DevSource.CACHE, DevSource.CACHE_DEV or
     *               DevSource.DEVICE.
     * @return An array of AttributeValue object. One AttributeValue object is
     * initialised for each wanted attribute
     * @throws DevFailed Thrown if one of the attribute does not exist or if a
     ...
     *
     * @param values The attribute(s) new set value. There is one AttributeValue
     ...
     *
     * @param new_attr Reference to the new attribute to be added to the list
     * @throws DevFailed . Click
     *                   <a
     *                   href="../../tango_basic/idl_html/Tango.html#DevFailed">here
     *                   </a> to read <b>DevFailed</b> exception specification
     */
     ...
     *
     * @return The device state
     * @throws DevFailed If it is necessary to read attribute(s) and a problem
     ...
     *
     * @param attr_list Reference to a vector of Integer objects. Each element in this
     ...
     *
     * @param id The CORBA object identifier
     */
